...
const GamePage: React.FC = () => {
  const { gameState, makeGuess, addLetter, removeLetter, resetGame, leaveRoom } = useGame();
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      if (gameState.gameStatus !== GameStatus.WAITING && gameState.gameStatus !== GameStatus.ACTIVE) return;
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mb-4">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Room: 
                <span 
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                Word: {gameState.room.wordLength} letters
              </p>
            </div>
        ...
        {gameState.gameStatus === GameStatus.WON && (
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 mb-4 text-center">
            ...
            <p className="text-sm text-green-600 dark:text-green-300 mt-1">
              You guessed the word in {gameState.attempts.length} {gameState.attempts.length === 1 ? 'try' : 'tries'}.
            </p>
          </div>
        )}
        ...
        {gameState.gameStatus === GameStatus.LOST && (
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 mb-4 text-center">
            ...
            <p className="text-sm text-red-600 dark:text-red-300 mt-1">
              The word was: <span className="font-bold">{gameState.room.word}</span>
            </p>
          </div>
        )}
        ...
        {/* Game Results */}
        {(gameState.gameStatus === GameStatus.WON || gameState.gameStatus === GameStatus.LOST) && (
          <div className="mt-8">
            <GameResults 
              players={gameState.room.players}
